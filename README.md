...
**NOTE**: This is a fork of the original Tone.js repository with fixes and improvements for G3-specific needs.

## Changes:

- fix for the race condition when the transport is paused ~exactly at the Source/Player scheduled start time which leads to the Source/Player playing the full audio instead of being silent
- [new] Source/Player `id` prop
- adjusted logging (debugging)
- added release script

### TODO
- remove unused functionality to improve performance
- add native video sync support


## Building and publishing new build
The build is published to AndreyMay/tonemod public github repo and be used as a dependency in package.json `"tone": "github:AndreyMay/tonemod"`.
