...
export class Player extends Source<PlayerOptions> {
	...
	/**
	 * The last time the player was started
	 */
	private _startTime?: Seconds;

	/**
	 * The offset position to start playback from
	 */
	private _offset?: Seconds;
	...
	protected _stop(time?: Time): void {
		// this.log("player.stop", this._id, time);
		const computedTime = this.toSeconds(time);
		this._activeSources.forEach((source) => {
			// this.log("_activeSources.stop", this._id, index, computedTime);
	...
	/**
	 * Get the time when the player was last started
	 */
	get startTime(): Seconds | undefined {
